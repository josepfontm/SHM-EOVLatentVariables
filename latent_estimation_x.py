...
U,S,V = np.linalg.svd(x_m[:,t],full_matrices=False)      #Calculate SVD based on the first 3/4 of data
xhat_svd = U[:4104,:1] @ np.transpose(U[:,:1]) @ x_m     #Estimate latent output data from SVD matrices
